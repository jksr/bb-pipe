...
open (IN,"<../../TMSTRAND/$file.sidechain") || die "Cannot open input file $file\n";
...
open (ECAP,">$dir/odds/ecap.odds") || die "Cannot creat output file ecap.odds\n";
open (EHGIN,">$dir/odds/ehg.in.odds") || die "Cannot creat output file ehg.in.odds\n";
open (EHGOUT,">$dir/odds/ehg.out.odds") || die "Cannot creat output file ehg.out.odds\n";
open (COREIN,">$dir/odds/core.in.odds") || die "Cannot creat output file core.in.odds\n";
open (COREOUT,">$dir/odds/core.out.odds") || die "Cannot creat output file core.out.odds\n";
open (PHGIN,">$dir/odds/phg.in.odds") || die "Cannot creat output file phg.in.odds\n";
open (PHGOUT,">$dir/odds/phg.out.odds") || die "Cannot creat output file phg.out.odds\n";
open (PCAP,">$dir/odds/pcap.odds") || die "Cannot creat output file pcap.odds\n";
